...
RSpec.describe 'Merchants with Most Revenue' do
  ...
  it 'can find the merchants with the most revenue; quantity 10' do
  ...
  it 'can find the merchants with the most revenue; quantity 1' do
    quantity = 1
  ...
  it 'returns the top 100 merchants by revenue if quantity is too big' do
    quantity = 100000
  ...
  it 'returns an error if the quantity is left blank (sad path)' do
    quantity = ""
  ...
  it 'returns an error if the quantity is entered as a string(sad path)' do
    quantity = "asdfg"
  ...
  it 'returns an error if no quantity param is entered(sad path)' do
